...
const GET_ALL_INSURANCE = `SELECT DISTINCT ON(createdTime) id,name,id_number,dob,sponser_name,status,service,agent_amount,paid_date,remarks,amount_paid_dates,to_char(createdTime,'DD/MM/YYYY') createdDate,company,cr_number,payment_method,
...
const GET_ALL_INSURANCE_QUERY = `SELECT id,name,id_number,dob,sponser_name,to_char(createdTime,'DD/MM/YYYY') createdDate,company,cr_number,payment_method,
...
const GET_ALL_INSURANCE_STATUS = `SELECT id,name,id_number,dob,sponser_name,to_char(createdTime,'DD/MM/YYYY') createdDate,company,cr_number,payment_method,
    total_amount,paid_amount,agent,mobileNumber,sub_category,balance_amount,fileId,status,service,agent_amount,paid_date,remarks,amount_paid_dates
    FROM insurance WHERE status = $1  LIMIT 200`

const GET_ALL_INSURANCE_QUERY_STATUS = `SELECT id,name,id_number,dob,sponser_name,to_char(createdTime,'DD/MM/YYYY') createdDate,company,cr_number,payment_method,
    total_amount,paid_amount,agent,mobileNumber,sub_category,balance_amount,fileId,status,service,agent_amount,paid_date,remarks,amount_paid_dates
...
const GET_ALL_INSURANCE_CRRDIT = `SELECT id,name,id_number,dob,sponser_name,to_char(createdTime,'DD/MM/YYYY') createdDate,company,cr_number,payment_method,
    total_amount,paid_amount,agent,mobileNumber,sub_category,balance_amount,fileId,status,service,agent_amount,paid_date,remarks,amount_paid_dates
    FROM insurance WHERE balance_amount != '0'  LIMIT 200`

const GET_ALL_INSURANCE_CREDIT_QUERY = `SELECT id,name,id_number,dob,sponser_name,to_char(createdTime,'DD/MM/YYYY') createdDate,company,cr_number,payment_method,
    total_amount,paid_amount,agent,mobileNumber,sub_category,balance_amount,fileId,status,service,agent_amount,paid_date,remarks,amount_paid_dates
...
sponser_name = $11, service = $12, remarks = $13, company = $14, cr_number = $15, status = $16, payment_method = $17 WHERE id = $1`
