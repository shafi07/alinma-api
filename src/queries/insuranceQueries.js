...
const GET_ALL_INSURANCE = `SELECT DISTINCT ON(createdTime) id,name,id_number,dob,
...
const GET_ALL_INSURANCE_QUERY = `SELECT DISTINCT ON(fileId,name) id,name,id_number,dob,
    total_amount,paid_amount,agent,mobileNumber,sub_category,balance_amount,fileId
