...
const GET_ALL_JAVASATH = `SELECT DISTINCT ON(createdTime) id,sponser_name,name,id_number,purpose,iqama,insurance,other,amount_paid_dates,remarks,agent,agent_amount,paid_date,professionName,newSponser,re_entry_type,boarder_number,payment_method,
...
const GET_ALL_JAVASATH_QUERY = `SELECT id,sponser_name,name,id_number,purpose,iqama,insurance,other,agent,agent_amount,paid_date,professionName,newSponser,re_entry_type,boarder_number,payment_method,
...
const GET_ALL_JAVASATH_STATUS = `SELECT id,sponser_name,name,id_number,purpose,iqama,insurance,other,agent,agent_amount,paid_date,professionName,newSponser,re_entry_type,boarder_number,payment_method,
total_amount,paid_amount,service,mobileNumber,mol,sub_category,balance_amount,to_char(createdTime,'DD/MM/YYYY') createdDate,fileId,status,amount_paid_dates,remarks,due,absheer_amount,qiwa_amount,government_fee,new_passport_number,expiry_date
FROM javasath WHERE status=$1`

const GET_ALL_JAVASATH_STATUS_QUERY = `SELECT id,sponser_name,name,id_number,purpose,iqama,insurance,other,agent,agent_amount,paid_date,professionName,newSponser,re_entry_type,boarder_number,payment_method,
total_amount,paid_amount,service,mobileNumber,mol,sub_category,balance_amount,to_char(createdTime,'DD/MM/YYYY') createdDate,fileId,status,amount_paid_dates,remarks,due,absheer_amount,qiwa_amount,government_fee,new_passport_number,expiry_date
FROM javasath WHERE (name ILIKE '%' || $1 || '%' OR mobileNumber ILIKE '%' || $1 || '%' OR id_number ILIKE '%' || $1 || '%') AND status = $2  LIMIT 200`

const GET_ALL_JAVASATH_CREDIT = `SELECT id,sponser_name,name,id_number,purpose,iqama,insurance,other,agent,agent_amount,paid_date,professionName,newSponser,re_entry_type,boarder_number,payment_method,
total_amount,paid_amount,service,mobileNumber,mol,sub_category,balance_amount,to_char(createdTime,'DD/MM/YYYY') createdDate,fileId,status,amount_paid_dates,remarks,due,absheer_amount,qiwa_amount,government_fee,new_passport_number,expiry_date
FROM javasath WHERE balance_amount != '0'`

const GET_ALL_JAVASATH_QUERY_CREDIT = `SELECT id,sponser_name,name,id_number,purpose,iqama,insurance,other,agent,agent_amount,paid_date,professionName,newSponser,re_entry_type,boarder_number,payment_method,
total_amount,paid_amount,service,mobileNumber,mol,sub_category,balance_amount,to_char(createdTime,'DD/MM/YYYY') createdDate,fileId,status,amount_paid_dates,remarks,due,absheer_amount,qiwa_amount,government_fee,new_passport_number,expiry_date
...
qiwa_amount=$22,government_fee=$23,new_passport_number=$24,expiry_date=$25,re_entry_type=$26,boarder_number =$27, status = $28, payment_method = $29 WHERE id = $1`
