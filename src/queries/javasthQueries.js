...
total_amount,paid_amount,service,mobileNumber,mol,sub_category,balance_amount,to_char(createdTime,'DD/MM/YYYY') createdTime,fileId,status,due,absheer_amount,qiwa_amount,government_fee,new_passport_number,expiry_date
